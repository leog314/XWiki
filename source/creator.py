...
""") # predefined articles
    ...
    for art in data:
        ...
        summary = latex_to_mathbox(summary)

        if sum([k in summary.lower() or k in title.lower() or summary=="." for k in ["xxx", "pornographic", "porn", "onlyfans"]])==0: # exclude discusting or irrevalent topics
            print(page.title)
